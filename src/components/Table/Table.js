...
const ind = fieldIndex(tableData.dataFromAPI[0], tableData.sort.field)
...
newData.unshift(tableData.dataFromAPI[0])
  ...
  return (
    <div className='Table'>
      <TableHeader 
        headerData={ tableData.dataFromAPI[0] } 
        setSortingField={ setSortingField } 
      />
      <TableBody bodyData={ (tableData.sort.field === '') ? tableData : ({...tableData, dataFromAPI: newData}) } /> 
    </div>
  )
}
...
// sortingField === 'id' ? newData : tableData
